...
final class ProtobufPluginTestHelper {
   ...
   */
  static TestProjectBuilder projectBuilder(Object context, String projectName) {
    return new TestProjectBuilder(context.getClass().getName(), projectName)
  }

  static final class TestProjectBuilder {
    String testFolderContext
    ...
    private TestProjectBuilder(String context, String projectName) {
      this.testFolderContext = context
    ...
    File build() {
      File projectDir = new File(
          System.getProperty('user.dir'), "build/tests/$testFolderContext/$testProjectName")
