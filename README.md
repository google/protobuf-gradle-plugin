...
e.g., [v0.7.5](https://github.com/google/protobuf-gradle-plugin/tree/v0.7.5).
...
## Latest Version
The latest version is ``0.7.5``. It requires at least Gradle 2.4 and Java 7.
...
buildscript {
  ...
  dependencies {
    classpath 'com.google.protobuf:protobuf-gradle-plugin:0.7.6-SNAPSHOT'
  }
}
```
