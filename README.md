...
A stand-alone example projects are located under [samples]
(https://github.com/google/protobuf-gradle-plugin/tree/master/samples).
Run `../gradlew build` under the interesting sample to test it out.
